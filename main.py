...
if choice == "1":
    ...
    speedup = [mediaSequencialTam1 / mediaParaleloTam1[i]
               for i in range(len(mediaParaleloTam1))]

    print(speedup)

    # Plotando o gráfico
    # 'bo-' representa pontos azuis interconectados (blue circles)
    plt.plot(threads, speedup, 'bo-')
